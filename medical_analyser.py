...
def analyze_medical_image(image, analysis_type, api_key, model="gpt-4o"):
    ...
    try:
        ...
        response = openai.chat.completions.create(
            model=model,
            messages=[
                {"role": "system", "content": "You are a medical AI assistant designed to help healthcare professionals analyze medical images. Provide detailed, structured analysis while emphasizing the importance of professional medical consultation. Always include disclaimers about the limitations of AI analysis."},
                {"role": "user", "content": [
...
def main():
    ...
    with col1:
        ...
        sample_images = {
            "Sample Skin Lesion": "https://upload.wikimedia.org/wikipedia/commons/6/6e/Basal_cell_carcinoma.jpg",
            "Sample X-ray": "https://upload.wikimedia.org/wikipedia/commons/8/8a/Chest_Xray_PA_3-8-2010.png",
            "Sample Eye": "https://upload.wikimedia.org/wikipedia/commons/4/4c/Human_eye_with_cataract.jpg",
            "Sample Wound": "https://upload.wikimedia.org/wikipedia/commons/3/3c/Wound_on_leg.jpg"
        }
        ...
        if uploaded_file is not None:
            ...
            try:
                ...
                response = requests.get(st.session_state.sample_image_url, headers=headers)
                if response.status_code == 200 and response.headers.get("Content-Type","").startswith("image"):
                    ...
                    st.error("Error loading demo image: Invalid image response from server.")
            except Exception as e:
